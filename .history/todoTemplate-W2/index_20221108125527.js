...
function remaining(){
    myList = document.querySelector('todoTasks').getElementsByTagName('li').length;

    remainingTasks = document.querySelector('.leftToDo')
...
const remainingTasks = document.querySelector
