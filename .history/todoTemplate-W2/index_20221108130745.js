...
function remaining() {
	const todoIdx = myList.findIndex((todo) => todo.id == false);
	myList[todoIdx].status = `You have ${todoTaskUl.length} remaining items left to be completed`;
	remainingTasks.textContent = myList
}
