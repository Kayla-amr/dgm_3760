...
function remaining(){
    let myListx = document.querySelector('.todoTasks').getElementsByTagName('li').length;

    remainingTasks.textContent = `You have ${myList} remaining items left to be completed`
}
